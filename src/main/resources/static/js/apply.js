...
function addProgressPlan(rownum) {
    ...
    row.append('<tr id="progressplan_'+rownum+'">' +
        '<td><input type="text" name="progressPlans['+rownum+'].time" class="form-control" value=""/></td>' +
        ...
        '<td><button class="btn btn-info" onclick="addProgressPlan('+rownum+')" type="button"><i class="glyphicon glyphicon-plus"></i></button>'+
...
function deleteProgressPlan(rownum) {
    ...
    rownum--;
    if(rownum==0){
        $("#progressplan_"+rownum).find("td").eq(-1).html('<button class="btn btn-info" onclick="addProgressPlan('+rownum+')" type="button"><i class="glyphicon glyphicon-plus"></i></button>'+
            ' <button class="btn btn-warning" type="button"><i class="glyphicon glyphicon-minus"></i></button>')
    }else{
...
function addExpenditure(rownum) {
    ...
    row.append('<tr id="expenditure_'+rownum+'">' +
        ...
        '<td><input type="text" name="expenditures['+rownum+'].money" class="form-control" value=""/></td>'+
