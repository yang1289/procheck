            ...
            <div class="box col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" id="step2" method="post" action="/project/applystep4?method=apply">
                                ...
                                <tbody id="progressplan">
                                    <#if project??>
                                        ...
                                        <tr id="progressplan_0">
                                            ...
                                            <td>
                                                <button class="btn btn-info" onclick="addProgressPlan(0),dateTime()" type="button"><i class="glyphicon glyphicon-plus"></i></button>
                            ...
                            <div class="form-group col-md-12">
                                <button type="button" id="baseapply" onclick="saveStep4()" class="btn btn-primary">保存并下一步</button>
                            </div>
