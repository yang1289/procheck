...
<div class="row">
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div id="alert"><#if message??><div class="alert alert-info" role="alert">${message}</div></#if></div>
        <div class="row">
            <div class="box col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">项目申请</div>
                    <div class="panel-body">
                        <form role="form" id="step1" method="post" action="/project/applystep1?method=edit">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="adviserId">
                                    <#list advisers as adviser>
                                        <option value="${adviser.id}" <#if project.adviser??><#if adviser.id==project.adviser.id>selected</#if></#if> >${adviser.chineseName}|${adviser.academy.name}</option>
                                    </#list>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                <button type="button" id="baseapply" onclick="saveBase()" class="btn btn-primary">保存</button>
                            </div>
