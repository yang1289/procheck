						...
						<tbody>
							<#list tasks as task>
								<tr>
									...
									<td><fmt:formatDate pattern="yyyy-MM-dd hh:MM:ss" value="${task.dataCreated}"/> </td>
									<td>${task.finished}</td>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="radio" class="col-sm-1" name="finished"
									value="true"<c:if test="${task.finished=='true'}">checked</c:if> />
								<div class="col-sm-1">Yes</div>
								<input type="radio" class="col-sm-1" name="finished"
									value="false" <c:if test="${task.finished=='false'}">checked</c:if> />
