...
public class HtmlConvert {
    public final String OUT_FILENAME = "申请表";
     ...
     * @throws Exception
     */
    public File saveUrlToDocx(Project project) throws Exception {
        return saveDocx(url2word(project));
    }
     ...
     * @throws Exception
     */
    public File saveUrlToPdf(Project project) throws Exception {
        return savePdf(url2word(project));
    }
     ...
     * @throws Exception
     */
    public WordprocessingMLPackage url2word(Project project) throws Exception {
        return xhtml2word(url2xhtml(project));
    }
    ...
    protected String genFilePath() {
        ...
        File TempFile=new File(userpath+"/temp");
        if(!TempFile.exists()){
            TempFile.mkdir();
        }
        return System.getProperty("user.dir") + "/temp/" + OUT_FILENAME;
    }
